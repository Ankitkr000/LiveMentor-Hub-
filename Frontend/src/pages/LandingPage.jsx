...
<CustomCursor />
  ...
  <div className="logo-section">
    <div className="logo-wrapper">
      <img src={Doubtlogo} alt="LiveMentor-Hub Logo" className="logo" />
    </div>
    <span className="brand-name">LiveMentor-Hub</span>
  </div>
...
<section className="why-choose">
  <h2 className="why-choose-heading">💡 Why Choose LiveMentor-Hub?</h2>
...
<section className="testimonial-section">
  ...
  <div className="testimonial-cards">
    <div className="testimonial-card">
      <p>"LiveMentor-Hub helped me ace my coding interview! I got connected to a senior engineer in 30 seconds."</p>
...
<section className="faq-section">
  ...
  <div className="faq-list">
    {[
      ...
      {
        question: "Is it free to use LiveMentor-Hub?",
...
<footer className="footer">
  <div className="footer-container">
    ...
    <div className="footer-brand">
      <img src={Doubtlogo} alt="LiveMentor-Hub Logo" className="footer-logo" />
      <h2 className="footer-title">LiveMentor-Hub</h2>
