    ...
    <>
      ...
      <nav className={styles["student-navbar"]}>
        <div className={styles["navbar-left"]}>
          ...
          <Link to={dashboardPath} className={styles["brand-link"]}>
            <img src={logo} alt="LiveMentor-Hub Logo" className={styles.logo} />
            <h1 className={styles["brand-name"]}>LiveMentor-Hub</h1>
          </Link>
        </div>
      ...
      <div className={`${styles.sidebar} ${sidebarOpen ? styles.open : ""}`}>
        <div className={styles["sidebar-header"]}>
          <h2 className={styles["sidebar-title"]}>LiveMentor-Hub</h2>
